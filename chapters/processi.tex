...
\textit{\indent Questo capitolo fornisce in dettaglio l'ambiente di ricerca adottato, le tecnologie impiegate e degli esperimenti condotti. 
...
\\\\
I relativi risultati e le conclusioni raggiunte di ogni esperimento verranno dibattute nel Capitolo \ref{cap:risultati}.
...
\end{lstlisting}
Per ottenere il risultato voluto, sono state apportate delle modifiche alla funzione \emph{WritePacket}. Si è introdotto una nuova logica che gestisce l'invio dei pacchetti aggiuntivi, 
