...
In questa sezione esamineremo come avvengono le ritrasmissioni.

\paragraph{ Sicurezza }

In questa sezione parliamo del tls 1.2 e 1.3 non nel dettaglio. Solo per accennare che non è supportato direttamente dal protocollo. 
Inoltre rivediamo l'handshake nel caso di uso del tls. 
