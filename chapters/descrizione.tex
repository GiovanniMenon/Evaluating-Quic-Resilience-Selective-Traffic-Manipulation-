...
\begin{itemize}
    ...
    \item \textit{\textbf{Fixed Bit}}: 1 bit, il valore fissato è 1 a meno che non sia un pacchetto di \emph{Negozazione di Versione}. I pacchetti che contengono 0 in questo campo devono venire scartati.
