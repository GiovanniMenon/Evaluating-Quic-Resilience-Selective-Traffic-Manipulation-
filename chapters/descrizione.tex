...
\noindent Un aspetto pratico importante è che, essendo costruito sopra \emph{UDP}, tutte le informazioni necessarie al funzionamento di QUIC sono contenute nel payload del datagramma UDP (Figura \ref{udp-datagram}).
