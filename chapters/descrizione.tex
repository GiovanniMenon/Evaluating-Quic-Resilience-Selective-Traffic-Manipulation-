...
\emph{QUIC} permette di ridurre significativamente il numero di scambi necessari per l'inizializzazione della connessione. In particolare, si possono identificare due scenari:
\begin{enumerate}
