...
\\
Sviluppato inizialmente da \emph{Google} nel 2012, \emph{Quick UDP Internet Connections (QUIC)}\footnote{\gls{QUIC}} è stato pensato per affrontare le sfide che i protocolli tradizionali faticavano a gestire, come le performance sulle reti mobili, la sicurezza e la latenza ridotta.
