...
\\\\
\noindent Per motivi di spazio, analizzeremo solo gli elementi trattati durante lo studio, concentrandoci in particolare su questi argomenti:
\begin{enumerate}
...
\\\\
\paragraph{\textit{Ritrasmissione}}
da fare spiegare l'uso del pbo a differenza del rto
\subsection{MPTCP}
~\\
