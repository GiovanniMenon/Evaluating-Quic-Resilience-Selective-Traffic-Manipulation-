...
\begin{itemize}
    ...
    \item \textit{\textbf{Reserved Bits}}: ..
    \item \textit{\textbf{Key Phase}}: ..
    \item \textit{\textbf{Packet Number Lenght}}: 
    \item \textit{\textbf{Destination Connection ID}}: 
    \item \textit{\textbf{Packet Number}}: 
    \item \textit{\textbf{Packet Payload}}: 
    \end{itemize}

    qua finito dopo aver fatto questo
