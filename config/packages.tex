...
\usepackage[backend=biber,style=numeric,hyperref,backref,sorting=none]{biblatex} % togli sorting none per aver l'ordine alfabetico
...
\usepackage{titlesec}
\usepackage{enumitem}                   % roman enumerate